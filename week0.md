# 🤖 first assignments: set-up, week 0 

welcome, hello world! 🌎 

We've got a few set-up tasks to get started ... the following is due by **Monday Aug. 31st by 11:59pm**:

1. **Read the [syllabus](https://github.com/mab253/cpp_fall26/blob/main/README.md)!** Please read-through the entire doc - includes a lot of helpful info about the structure and philosophy of this course
...
- Enter zyBook code: CUNYCSC10300BlountFall2026
- Subscribe
...
3. **Join our Discord server** - the invite link is posted in Brightspace
- [Instructions here!](https://github.com/mab253/cpp_fall26/blob/main/discord.md)
- Make note of the user name you choose - you will need it for the survey.
- If you have issues joining the Discord by Monday, please reach out to me via email 
...
- ✨[Survey here](https://airtable.com/appbqrZUDUsULkaDS/shrVLLYAfV88XTQiQ) - password: protonc++26
