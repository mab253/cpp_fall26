...
- [Colossal Cave Adventure](https://grack.com/demos/adventure/), the version we played in the browser
- [FORTRAN: Colossal Cave Adventure](https://github.com/wh0am1-dev/adventure/blob/master/src/77-03-11_adventure.f), 1 version of the original game in FORTRAN langauge
- [full map, Adventure](https://www.spitenet.com/cave/) - 1 person's version!
