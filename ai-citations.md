...
This is an evolving topic - as a coder myself, I have been experimenting with light generative AI use in my workflow, and I understand that it's possible that a big part of anyone's coding (or writing, researching, working, etc.) life in the future _might_ (maybe!) involve smart use of these tools. **However**, as you are students learning to code, I have concerns about what you "skip over" in your brain when you leap to asking AI to solve a problem. I have had students in the past say that it feels like an addictive habit, something that might help you solve a last-minute lab problem late at night before the deadline, but over time can hinder you actually knowing how to code. When you hit a roadblock in your thinking, which is a natural part of programming, the next step can't always be to look up an easy answer. In this way, learning to program is really a way of learning to think. We need to understand _how_ and _why_ our code works - and further, if we _choose_ to use tools like AI, we need to be able to learn to prompt with the right questions. As scientists and engineers, we also need to understand _how large language models (LLMs) work_, and when they don't, before we start using them seriously. There are other reasons, including ethical ones, against using AI for generating code. You may have other limits for yourself. We will talk a lot more about this during the semester, and I'm eager to hear your opinions and experiences.

That said: I know these tools are out there and being used. They are changing and (possibly) improving all the time. I can only highly encourage you to use generative AI tools _sparingly_. When you do turn to an LLM, I suggest using it mostly as a tutor, asking conversational questions to deepen your understanding of the material rather than asking the bot to generate answers. We'll discuss more about this difference.

### **💥 In this class, you will need to cite WHENEVER and HOWEVER you use generative AI tools (chatGPT, claude, etc.) to improve your code or come up with a solution. 💥**

Example: 

```
/* -----
This code was written with the aid of Gemini;
